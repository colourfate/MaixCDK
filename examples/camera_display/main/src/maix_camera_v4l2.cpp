...
namespace maix::camera_v4l2
{
    ...
    public:
        ...
        camera_v4l2::CameraV4L2 *add_channel(int width, int height, image::Format forma, int buff_num)
        {
            return NULL;
        }
    ...
    camera_v4l2::Camera *Camera::add_channel(int width, int height, image::Format format, double fps, int buff_num, bool open)
    {
        return NULL;
    }
